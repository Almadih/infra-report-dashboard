...
const handlePageChange = (page: number) => {
    ...
    router.get(route('reports-map'), { page, ...query }, {
        preserveState: true,
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="flex min-h-screen flex-col">
            <div class="flex flex-1">
                <div class=" w-85 border-r bg-background p-4 md:block">
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <label htmlFor="status-open" class="flex items-center text-sm font-medium">
                                        <Badge variant="outline" :class="statusColors['pending']">
                                            Pending
                                        </Badge>
                                    </label>
                                </div>
                                <div class="flex items-center space-x-2">
                                    ...
                                    <label htmlFor="status-in-progress" class="flex items-center text-sm font-medium">
                                        <Badge variant="outline" :class="statusColors['under_review']">
                                            Under Review
                                        </Badge>
                                    </label>
                                </div>
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <label htmlFor="status-in-progress" class="flex items-center text-sm font-medium">
                                        <Badge variant="outline" :class="statusColors['verified']">
                                            Verified
                                        </Badge>
                                    </label>
                                </div>
                                <div class="flex items-center space-x-2">
                                    ...
                                    <label htmlFor="status-resolved" class="flex items-center text-sm font-medium">
                                        <Badge variant="outline" :class="statusColors['resolved']">
                                            Resolved
                                        </Badge>
                                    </label>
                                </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <Button v-if="filters.location" variant="ghost" size="icon"
                                    class="absolute right-0 top-0 h-full" onClick={clearLocationFilter}>
                                    <X class="h-4 w-4" />
                ...
                <div class="relative flex-1">
                    ...
                    <Card v-if="selectedReport" class="absolute bottom-4 left-4 right-4 z-10">
                        ...
                        <CardContent class="grid grid-cols-1 gap-2 p-3 pt-0 text-xs">
                            <dl class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <dd class="text-sm">
                                        <Badge variant="outline" :class="statusColors[selectedReport.status.name as keyof typeof
                                            statusColors]">
                                ...
                                <div>
                                    <dt class="text-sm font-medium text-muted-foreground">Reported On</dt>
                                    <dd class="text-sm">{{ formatDate(selectedReport.created_at) }}</dd>
                                </div>

                                <div>
                                    <dt class="text-sm font-medium text-muted-foreground">Damage Type</dt>
