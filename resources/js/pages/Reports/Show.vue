                        ...
                        <Card>
                            ...
                            <CardContent>
                                <dl class="grid grid-cols-2 gap-4 ">
                                    <div>
                                        <dt class="text-sm font-medium text-muted-foreground">Report ID</dt>
                                    ...
                                    <div>
                                        ...
                                        <dd class="text-sm">
                                            <Badge variant="outline" :class="statusColors[report.status.name as keyof typeof
                                                statusColors]">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <Map class="h-[500px]" :zoom="9" :center="{
                                ...
                                <GMapMarker :position="{
                                    lat: report.location.coordinates[1], lng:
                                        report.location.coordinates[0], zoom: 16
                                }" />
                            </Map>
                        </CardContent>
                    </Card>
