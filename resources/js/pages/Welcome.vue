...
<template>
    ...
    <div class="flex flex-col min-h-screen bg-gradient-to-b from-slate-50 to-white">
        <header class="px-4 lg:px-6 h-16 flex items-center border-b bg-white/80 backdrop-blur-sm sticky top-0 z-50">
            <Link href="/" class="flex items-center justify-center">
            <div class="flex items-center space-x-2">
                <div class="w-8 h-8 bg-emerald-600 rounded-lg flex items-center justify-center">
                    <AlertTriangle class="h-5 w-5 text-white" />
                </div>
                <span class="font-bold text-xl text-slate-900">InfraReport</span>
            </div>
            </Link>
            <nav class="ml-auto flex gap-4 sm:gap-6">
                ...
                <template v-else>
                    <Link :href="route('login')" class="text-sm font-medium hover:text-emerald-600 transition-colors">
                    Log in
                    </Link>
                </template>
                <Link href="#features" class="text-sm font-medium hover:text-emerald-600 transition-colors">
                Features
                </Link>
                <Link href="#how-it-works" class="text-sm font-medium hover:text-emerald-600 transition-colors">
                How It Works
                </Link>
                <Link href="#impact" class="text-sm font-medium hover:text-emerald-600 transition-colors">
                Impact
                </Link>
                <Link href="#contact" class="text-sm font-medium hover:text-emerald-600 transition-colors">
                Contact
                </Link>
            </nav>
        </header>
        ...
        <main class="flex-1">
                        ...
                        <div class="flex flex-col justify-center space-y-4">
                            <div class="space-y-2">
                                <Badge variant="secondary"
                                    class="w-fit bg-emerald-100 text-emerald-800 hover:bg-emerald-100">
                                    Empowering Communities
                                </Badge>
                                <h1
                                    class="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none text-slate-900">
                                    Report Infrastructure Issues. <span class="text-emerald-600">Build Safer
                                        Communities.</span>
                                </h1>
                                <p class="max-w-[600px] text-slate-600 md:text-xl">
                                    Help your community by reporting potholes, broken bridges, damaged schools, and
                                    other infrastructure
                                    issues. Together, we can ensure faster repairs and safer public spaces for everyone.
                                </p>
                            </div>
                            <div class="flex flex-col gap-2 min-[400px]:flex-row">
                                <Button size="lg" class="bg-emerald-600 hover:bg-emerald-700">
                                    Start Reporting
                                </Button>
            ...
            <section class="w-full py-12 md:py-24 lg:py-32 bg-slate-100">
                <div class="flex-1 px-4 md:px-6">
                    <div class="flex flex-col items-center justify-center space-y-4 text-center">
                        <div class="space-y-2">
                            <h2 class="text-3xl font-bold tracking-tighter sm:text-5xl text-slate-900">
                                The Problem We're Solving
                            </h2>
                            <p
                                class="max-w-[900px] text-slate-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                Infrastructure damage often goes unreported, leading to safety risks and inefficient
                                resource
                                allocation. Traditional reporting channels are inaccessible or underutilized by
                    ...
                    <div class="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
                        ...
                        <Card class="border-0 shadow-lg h-full">
                            <CardHeader class="text-center">
                                ...
                                <CardTitle class="text-xl">Delayed Repairs</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <p class="text-center text-slate-600">
                        ...
                        <Card class="border-0 shadow-lg h-full">
                            <CardHeader class="text-center">
                                ...
                                <CardTitle class="text-xl">Resource Waste</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <p class="text-center text-slate-600">
                ...
                <div class="flex-1 px-4 md:px-6">
                    <div class="flex flex-col items-center justify-center space-y-4 text-center">
                        <div class="space-y-2">
                            ...
                            <h2 class="text-3xl font-bold tracking-tighter sm:text-5xl text-slate-900">How It Works</h2>
                            <p
                                class="max-w-[900px] text-slate-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                Reporting infrastructure damage is as easy as taking a photo. Our streamlined process
                                ensures your
                                reports reach the right authorities quickly.
                            </p>
                        </div>
                    </div>
                    <div class="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
                        <div class="flex flex-col items-center text-center space-y-4">
                            <div
                                class="w-16 h-16 bg-emerald-600 rounded-full flex items-center justify-center text-white text-xl font-bold">
                                1
                            </div>
                            <Camera class="h-12 w-12 text-emerald-600" />
                            <h3 class="text-xl font-bold">Spot & Capture</h3>
                        ...
                        <div class="flex flex-col items-center text-center space-y-4">
                            ...
                            <MapPin class="h-12 w-12 text-emerald-600" />
                            <h3 class="text-xl font-bold">Report & Describe</h3>
                            <p class="text-slate-600">
                        ...
                        <div class="flex flex-col items-center text-center space-y-4">
                            ...
                            <Wrench class="h-12 w-12 text-emerald-600" />
                            <h3 class="text-xl font-bold">Track & Fix</h3>
                            <p class="text-slate-600">
            ...
            <section id="features" class="w-full py-12 md:py-24 lg:py-32 bg-slate-50">
                <div class="flex-1 px-4 md:px-6">
                    <div class="flex flex-col items-center justify-center space-y-4 text-center">
                        <div class="space-y-2">
                            <Badge variant="secondary" class="bg-emerald-100 text-emerald-800">
                    ...
                    <div class="grid items-center gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
                        <div class="flex flex-col justify-center space-y-4">
                            <div class="space-y-2">
                                ...
                                <p
                                    class="max-w-[600px] text-slate-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                            ...
                            <div class="grid grid-cols-2 gap-4 py-4">
                                <div class="space-y-2">
                                    ...
                                    <p class="text-sm text-slate-600">Faster repair response times</p>
                                </div>
                                <div class="space-y-2">
                                    <div class="text-2xl font-bold text-emerald-600">75%</div>
                                    <p class="text-sm text-slate-600">Increase in reported issues</p>
                                </div>
                                <div class="space-y-2">
                                    <div class="text-2xl font-bold text-emerald-600">30%</div>
                                    <p class="text-sm text-slate-600">Reduction in maintenance costs</p>
                                </div>
                                <div class="space-y-2">
                                    <div class="text-2xl font-bold text-emerald-600">95%</div>
                                    <p class="text-sm text-slate-600">User satisfaction rate</p>
                                </div>
                            </div>
                            <div class="flex flex-col gap-2 min-[400px]:flex-row">
                                <Button class="bg-emerald-600 hover:bg-emerald-700">Join the Movement</Button>
            ...
            <section class="w-full py-12 md:py-24 lg:py-32 bg-slate-50">
                <div class="flex-1 px-4 md:px-6">
                    <div class="flex flex-col items-center justify-center space-y-4 text-center">
                        <div class="space-y-2">
                            <h2 class="text-3xl font-bold tracking-tighter sm:text-5xl text-slate-900">What Can You
                                Report?</h2>
                            <p
                                class="max-w-[900px] text-slate-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    ...
                    <div class="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-8">
                        <Card class="border-0 shadow-lg hover:shadow-xl transition-shadow">
                            <CardHeader class="text-center">
                                <div
                                    class="mx-auto w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mb-4">
                                    <Road class="h-6 w-6 text-blue-600" />
                                </div>
                                <CardTitle>Road Infrastructure</CardTitle>
                            </CardHeader>
                            <CardContent>
                        ...
                        <Card class="border-0 shadow-lg hover:shadow-xl transition-shadow">
                            <CardHeader class="text-center">
                                <div
                                    class="mx-auto w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center mb-4">
                                    <Building class="h-6 w-6 text-green-600" />
                                </div>
                                <CardTitle>Public Buildings</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <ul class="space-y-2 text-sm text-slate-600">
                        ...
                        <Card class="border-0 shadow-lg hover:shadow-xl transition-shadow">
                            <CardHeader class="text-center">
                                <div
                                    class="mx-auto w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center mb-4">
                                    <AlertTriangle class="h-6 w-6 text-purple-600" />
                                </div>
            ...
            <section class="w-full py-12 md:py-24 lg:py-32 bg-emerald-600">
                <div class="flex-1 px-4 md:px-6">
                    <div class="flex flex-col items-center justify-center space-y-4 text-center">
                        <div class="space-y-2">
                            ...
                            <p
                                class="max-w-[900px] text-emerald-100 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                Join thousands of citizens already making a difference. Start reporting infrastructure
                                issues today
                                and help build stronger, safer communities for everyone.
                            </p>
                        </div>
                        <div class="flex flex-col gap-2 min-[400px]:flex-row">
                            <Button size="lg" class="bg-white text-emerald-600 hover:bg-slate-100">
                                Download the App
                            </Button>
                            <Button size="lg" class="bg-white text-emerald-600 hover:bg-slate-100">
                                Learn More
                        ...
                        <p class="text-sm text-emerald-100">
                            Available on Android • Free to use • No registration required
                        </p>
                    </div>
                </div>
            </section>
        ...
        <footer id="contact"
            ...
            <div class="flex-1 flex flex-col md:flex-row justify-between items-center">
                <div class="flex items-center space-x-2">
                    <div class="w-6 h-6 bg-emerald-600 rounded flex items-center justify-center">
                        <AlertTriangle class="h-4 w-4 text-white" />
                    </div>
                    <span class="font-bold text-slate-900">InfraReport</span>
                </div>
                <p class="text-xs text-slate-600">© 2024 InfraReport. Building safer communities together.</p>
                <nav class="flex gap-4 sm:gap-6">
                    <Link href="#" class="text-xs hover:underline underline-offset-4 text-slate-600">
                    Privacy Policy
                    </Link>
                    <Link href="#" class="text-xs hover:underline underline-offset-4 text-slate-600">
                    Terms of Service
